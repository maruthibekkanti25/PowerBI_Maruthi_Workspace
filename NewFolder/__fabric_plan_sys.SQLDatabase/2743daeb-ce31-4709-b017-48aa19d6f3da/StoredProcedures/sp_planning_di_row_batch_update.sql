            ...
            CREATE PROCEDURE [2743daeb-ce31-4709-b017-48aa19d6f3da].[sp_planning_di_row_batch_update] 
            ...
            DECLARE @TempTableName NVARCHAR(128) = '#CR_UPDATE_TEMP' + REPLACE(REPLACE(REPLACE(REPLACE(@currentTimeString, '-', ''), ':', ''),' ',''),'.','');
              ...
              -- Insert data into the temporary table using dynamic SQL
                ...
                SET @sql = @sql + 'UPDATE [2743daeb-ce31-4709-b017-48aa19d6f3da].data_input_row 
                SET 
                    ...
                    updatedBy = @updatedBy,
                    updatedAt = @updatedAt
                FROM [2743daeb-ce31-4709-b017-48aa19d6f3da].data_input_row
                INNER JOIN [2743daeb-ce31-4709-b017-48aa19d6f3da].' +  @TempTableName + ' as temp on temp.id = data_input_row.id;';
